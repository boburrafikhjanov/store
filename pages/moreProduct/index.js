...
import MoreProduct from "../../components/HotOffer/MoreProduct";
...
const moreCheap = () => {
  ...
  return (
    <>
      ...
      <Tracker />
      <MoreProduct  discount={router.query.discount} category_id={router.query.category_id}/>
    </>
  );
};

export default moreCheap;
